    ...
    public class DataMigrations : IDataMigrations
    {
        ...
        public void Initialize()
        {
            foreach (var databaseKey in databaseKeys)
            {
                ...
                * we are not invoking the previous procedure, as we are running migrations againt LSOmni
                */
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want Dashboard migrations to run on your DB.
            // removed as we are running migrations against LSOmni
           /*
            ...
            */
            ...
            // registering migration conventions with [serene] schema (not default dbo schema)
            var conventionSet = new DefaultConventionSet(defaultSchemaName: "serene",
                Path.GetDirectoryName(typeof(DataMigrations).Assembly.Location));
            var migrationNamespace = "Dashboard.Migrations." + databaseKey + "DB";
